...
@section('title-bar') เพิ่มเครื่อง EDC @endsection
@section('subheader-title') เพิ่มเครื่อง EDC @endsection
						...
						<div class="col-xl-12 col-xxl-10">
							...
							<!-- <form class="form fv-plugins-bootstrap fv-plugins-framework" id="kt_form"> -->
								<div class="row justify-content-center">
									<div class="col-xl-9">
									<form action="{{ route('root.device.store') }}" method="POST" class="mb-4" id="inputFrm">
									@csrf
									@method('POST')
										<!--begin::Wizard Step 1-->
										<div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
											...
											<div class="form-group row fv-plugins-icon-container">
												...
												<div class="col-lg-9 col-xl-9">
													<input class="form-control form-control-solid form-control-lg" name="serial_number" type="text"  value="{{-- old('serial_number') --}}" required>
			...
			$.ajax({
				...
				success: function(response) {
					Swal.fire({
						...
						text: 'ต้องการกลับไปหน้าแสดงรายการหรือไม่',
						showDenyButton: true,
						showCancelButton: true,
						confirmButtonText: 'ไปหน้าแสดงรายการ',
						cancelButtonText: 'เพิ่มข้อมูลต่อ',
					}).then((result) => {
						
						if (result.isConfirmed) {
							window.location.href = "{{ route('root.device.index')}}";
						} else {
							window.location.href = "{{ route('root.device.create')}}";
						}
					});
				},
