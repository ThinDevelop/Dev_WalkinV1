                        ...
                        <div class="card-spacer bg-white card-rounded flex-grow-1">
                            ...
                            <div class="row m-0">
                                <div class="col px-8 py-6 mr-8 text-center">
                                    <div class="font-size-lg text-muted font-weight-bold">จำนวนคนเข้า</div>
                                    <div class="font-size-h4 font-weight-bolder">378</div>
                                </div>
                                <div class="col px-8 py-6 text-center">
                                    <div class="font-size-lg text-muted font-weight-bold">จำนวนคนออก</div>
                                    <div class="font-size-h4 font-weight-bolder">196</div>
                                </div>
                            </div>
                            <!--end::Row-->
                            <!--begin::Row-->
                            <div class="row m-0">
                                <div class="col px-8 py-6 mr-8 text-center">
                                    <div class="font-size-lg text-muted font-weight-bold">จำนวนคนตกค้าง</div>
                                    <div class="font-size-h4 font-weight-bolder">378</div>
                                </div>
                                <div class="col px-8 py-6 text-center">
                                    <div class="font-size-lg text-muted font-weight-bold">รวมทั้งหมด</div>
                                    <div class="font-size-h4 font-weight-bolder">574</div>
                                </div>
                            </div>
                            <!--end::Row-->
                        </div>
                    ...
                    <div class="card-body pt-2 pb-0">
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless table-vertical-center">
                                <thead>
                                    <tr>
                                        <th class="pl-0 text-right" style="width: 50px"><span class="text-dark font-weight-bolder d-block font-size-lg">รูปภาพ</span></th>
                                        <th class="pl-0 text-right" style="min-width: 150px"><span class="text-dark font-weight-bolder d-block font-size-lg">ชื่อ / วัตถุประสงค์</span></th>
