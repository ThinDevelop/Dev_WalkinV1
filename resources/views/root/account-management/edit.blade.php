...
@section('title-bar') แก้ไขผู้ใช้งาน @endsection
@section('subheader-title') แก้ไขผู้ใช้งาน >> {{ $user->username }} @endsection
						...
						<div class="col-xl-12 col-xxl-10">
							...
							<!-- <form class="form fv-plugins-bootstrap fv-plugins-framework" id="kt_form"> -->
								<div class="row justify-content-center">
									<div class="col-xl-9">
									<form action="{{ route('root.account.update', $user->id ) }}" method="POST" class="mb-4" id="inputFrm">
									@csrf
									@method('PUT')
										<!--begin::Wizard Step 1-->
										<div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
                                            ...
                                            <div class="form-group row fv-plugins-icon-container">
												...
												<div class="col-lg-9 col-xl-9">
                                                    <select class="form-control seltitle" id="company_parent_id" name="company_parent_id" title="{{ $user->company_parent_id }}">
