...
@section('title-bar') เพิ่มบริษัท @endsection
@section('subheader-title') เพิ่มบริษัท @endsection
                ...
                <div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
                    <div class="col-xl-12 col-xxl-10">
                        <div class="row justify-content-center">
                            <div class="col-xl-9">
                                <form action="{{ route('root.company.store') }}" method="POST" class="mb-4" id="inputFrm">
                                @csrf
                                @method('POST')
                                <div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
                                    ...
                                    <div class="form-group row fv-plugins-icon-container">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <input class="form-control form-control-solid form-control-lg" name="name" type="text"  value="{{ old('name') }}" required>
                                    ...
                                    <div class="form-group row fv-plugins-icon-container">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <input class="form-control form-control-solid form-control-lg" name="address" type="text"  value="{{ old('address') }}" required>
                                        <div class="fv-plugins-message-container"></div></div>
                                    </div>
                                    ...
                                    <div class="form-group row fv-plugins-icon-container">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <input class="form-control form-control-solid form-control-lg" name="phone" type="text"  value="{{ old('phone') }}" required>
                                        <div class="fv-plugins-message-container"></div></div>
                                    </div>
                                    ...
                                    <div class="form-group row fv-plugins-icon-container">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <input class="form-control form-control-solid form-control-lg" name="email" type="email"  value="{{ old('email') }}" required>
                                        <div class="fv-plugins-message-container"></div></div>
                                    </div>
