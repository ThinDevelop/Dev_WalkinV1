...
@section('title-bar') จัดการผู้ดูแลระบบ @endsection
@section('subheader-title') จัดการผู้ดูแลระบบ @endsection
@section('button-header')

    <!--begin::Dropdown-->
    <div class="dropdown dropdown-inline" data-toggle="tooltip" title="เพิ่มผู้ดูแลระบบ" data-placement="left">
        <a href="{{ route('root.user.create') }}" class="btn btn-fixed-height btn-white btn-hover-primary font-weight-bold px-2 px-lg-5 mr-2" >
...
<script type="text/javascript">
            ...
            columnDefs: [
                {
                    ...
                    render: function(data, type, row, meta) {
                        return  '<a href="/root/user/'+data+'/edit"  class="btn btn-sm btn-clean btn-icon" title="แก้ไข">'+
                                ...
                                '<form id="myform'+data+'" action="/root/user/'+data+'" method="POST">'+
                                '@csrf'+
                                '@method("DELETE")    '+
    ...
    $(document).on("click", ".delete", function() { 
        ...
        Swal.fire({
            title: "คุณต้องการจะลบผู้ดูแลระบบ '"+username+"' หรือไม่ ?",
