<!--begin::Tab Pane-->
<div class="tab-pane fade {{ Request::is('root/dashboard*') || Request::is('root/user*') || Request::is('root/change/password*')  ? 'show active' : '' }}" id="kt_aside_tab_1">
    <!--begin::Aside Menu-->
    <div class="aside-menu-wrapper flex-column-fluid px-10 py-5" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu_1" class="aside-menu" data-menu-vertical="1" data-menu-scroll="1">
            <!--begin::Menu Nav-->
            <ul class="menu-nav">
                <li class="menu-item {{ Request::is('root/dashboard*')  ? 'menu-item-active' : '' }}" aria-haspopup="true">
                ...
                <li class="menu-section">
                    <h4 class="menu-text">จัดการข้อมูล</h4>
                    <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                </li>
                <li class="menu-item {{ Request::is('root/user*')  ? 'menu-item-active' : '' }}" aria-haspopup="true">
                    <a href="{{route('root.user.index')}}" class="menu-link">
                    <span class="svg-icon menu-icon"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo3\dist/../src/media/svg/icons\Communication\Address-card.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <rect x="0" y="0" width="24" height="24"/>
                ...
                <li class="menu-item {{ Request::is('root/change/password*')  ? 'menu-item-active' : '' }}" aria-haspopup="true">
                    <a href="{{route('root.change.password')}}" class="menu-link">
