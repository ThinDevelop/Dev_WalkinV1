<!--begin::Tab Pane-->
<div class="tab-pane fade {{ Request::is('admin/report/*') ? 'show active' : '' }}"
    id="kt_aside_tab_6">
    <!--begin::Aside Menu-->
        ...
        <div id="kt_aside_menu_3" class="aside-menu" data-menu-vertical="1" data-menu-scroll="1">
            ...
            <ul class="menu-nav">
                ...
                <li class="menu-section px-0">
                    <span class="my-auto font-weight-bold">รายงาน</span>
                    <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                </li>

                <li class="menu-item {{ Request::is('admin/report/today') ? 'menu-item-active' : '' }}"
                    aria-haspopup="true">
                    <a href="{{ route('admin.report.today') }}" class="menu-link">
                ...
                <li class="menu-item {{ Request::is('admin/report/week') ? 'menu-item-active' : '' }}"
                    aria-haspopup="true">
                    <a href="{{ route('admin.report.week') }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <!--begin::Svg Icon-->
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                ...
                <li class="menu-item {{ Request::is('admin/report/month') ? 'menu-item-active' : '' }}"
                    aria-haspopup="true">
                    <a href="{{ route('admin.report.month') }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <!--begin::Svg Icon-->
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                ...
                <li class="menu-item {{ Request::is('admin/report/custom') ? 'menu-item-active' : '' }}"
                    aria-haspopup="true">
                    <a href="{{ route('admin.report.custom') }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <!--begin::Svg Icon-->
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                ...
                <li class="menu-item {{ Request::is('admin/report/files') ? 'menu-item-active' : '' }}"
                    aria-haspopup="true">
                    <a href="{{ route('admin.report.files') }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <!--begin::Svg Icon-->
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
