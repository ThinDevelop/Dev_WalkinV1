<!--begin::Tab Pane-->
<div class="tab-pane fade {{ Request::is('admin/change-password') ? 'show active' : '' }}" id="kt_aside_tab_7">
    <!--begin::Aside Menu-->
    <div class="aside-menu-wrapper flex-column-fluid px-10 py-5" id="kt_aside_menu_wrapper_3">
        ...
        <div id="kt_aside_menu_3" class="aside-menu" data-menu-vertical="1" data-menu-scroll="1">
            ...
            <ul class="menu-nav">
                ...
                <li class="menu-item {{ Request::is('admin/change-password')  ? 'menu-item-active' : '' }}" aria-haspopup="true">
                    <a  href="{{route('admin.changePassword')}}" class="menu-link">
