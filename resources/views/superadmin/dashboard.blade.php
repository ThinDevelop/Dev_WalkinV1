                    ...
                    <div class="card-spacer bg-white card-rounded flex-grow-1">
                        ...
                        {{-- <div class="row m-0">
                            ...
                            <div class="col px-8 py-6 text-center">
                                <div class="font-size-lg text-muted font-weight-bold">จำนวนบริษัทที่ใช้งาน</div>
                                <div class="font-size-h4 font-weight-bolder">{{ $company_active }}</div>
                            </div>
                        </div> --}}
            ...
            <div class="card card-custom gutter-b">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label font-weight-bolder text-dark">ข้อมูลผู้มาติดต่อล่าสุด</span>
        ...
        var KTDatatablesDataSourceAjaxServer = function() {
            ...
            var initTable1 = function() {
                ...
                table.DataTable({
                    ...
                    ajax: {
                        url: "/superadmin/dashboard/contact",
                        type: 'GET',
                        data: {
                    ...
                    columnDefs: [{
                        ...
                        },
                        {
                            ...
                            render: function(data, type, full, meta) {
                                if (data != 0) {
                                    return '<a href="/superadmin/dashboard/detail/out/' + full.id +
                                        '">' + data + '</a>';
                                } else {
                                    return '-';
                                }
                        ...
                        },
                        {
                            ...
                            render: function(data, type, full, meta) {
                                if (data != 0) {
                                    return '<a href="/superadmin/dashboard/detail/out/' +
                                        full.id + '">' + data + '</a>';
                                } else {
                                    return '-';
                                }
                        ...
                        },
                        {
                            ...
                            render: function(data, type, full, meta) {
                                if (data != 0) {
                                    return '<a href="/superadmin/dashboard/detail/stay/' +
                                        full.id + '">' + data + '</a>';
                                } else {
                                    return '-';
                                }
