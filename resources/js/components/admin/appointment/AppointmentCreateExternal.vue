                        ...
                        <form @submit.prevent="submitForm">
                            ...
                            <div class="my-5 step">
                                ...
                                <div class="col text-center my-3">
                                    <img :alt="logoAlt" :src="logoUrl" class="logo-default mx-auto w-25">
                                </div>
                                <!--end::Logo-->
                                ...
                                <h5 class="text-dark font-weight-bold mb-10">รายละเอียดการนัดหมาย</h5>
                                    ...
                                    <div class="form-group row fv-plugins-icon-container">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <input v-bind:class="'form-control form-control-solid form-control-lg ' +valid.name" placeholder="ชื่อ" id="formData.name" type="text" v-model="formData.name">
                                                </div>
                                                <div class="col-md-6">
                                                    <input v-bind:class="'form-control form-control-solid form-control-lg ' +valid.lastname" placeholder="นามสกุล" id="formData.lastname" type="text" v-model="formData.lastname">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="input-group input-group-solid input-group-lg">
                                                        ...
                                                        <input type="text" v-bind:class="'form-control form-control-solid form-control-lg ' +valid.phone" placeholder="เบอร์โทรศัพท์" id="formData.phone" v-model="formData.phone">
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="input-group input-group-solid input-group-lg">
                                                        ...
                                                        <input type="text" v-bind:class="'form-control form-control-solid form-control-lg ' +valid.email" placeholder="อีเมล" id="formData.email" v-model="formData.email">
                                                    </div>
                                                    <div class="fv-plugins-message-container"></div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group row fv-plugins-icon-container">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <select class='form-control form-control-solid form-control-lg' id="formData.department_id" v-model="formData.department_id">
                                    ...
                                    <div class="form-group row fv-plugins-icon-container">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <select v-bind:class="'form-control form-control-solid form-control-lg ' +valid.objective_id" id="formData.objective_id" v-model="formData.objective_id">
                                                <option value="" disabled selected>เลือกวัตถุประสงค์</option>
                                                <option v-for="obj in objectiveTypes" :key="obj.id" :value="obj.id">{{ obj.name }}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <!--end::Group-->
                                    ...
                                    <div class="form-group row fv-plugins-icon-container">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <input class='form-control form-control-solid form-control-lg' placeholder="ชื่อบริษัท" id="formData.from" type="text" v-model="formData.from"/>
                                        </div>
                                    </div>
                                    <!--end::Group-->
                                    ...
                                    <div class="form-group row fv-plugins-icon-container">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <textarea class='form-control form-control-solid form-control-lg resize-none' placeholder="รายละเอียดเพิ่มเติม (ถ้ามี)" id="formData.note" v-model="formData.note" rows="8" cols="80"></textarea>
                                    ...
                                    <div class="form-group row fv-plugins-icon-container border-top pt-5 mt-5">
                                        ...
                                        <div>
                                            <a href="/" class="btn btn-danger font-weight-bolder px-auto py-2 mr-1" style="width: 150px; font-size:16px">
                                                ย้อนกลับ
                                            </a>
...
export default{
    data(){
        return{
            logoUrl: '/images/logo/Walkin-icon-2.png',
            logoAlt: 'Logo',
            formData: {
                id: null,
                name: null,
    ...
    mounted() {
        ...
        console.log(`${this.serverUrl}/${this.company.logo}`);
    },
    created() {
    ...
    methods:{
        async checkLogoUrl() {
            const logoUrl = this.company.logo;
            if (logoUrl) {
                try {
                    const response = await fetch(`${this.serverUrl}/${logoUrl}`, { method: 'HEAD' });
                    if (response.ok) {
                        this.logoUrl  = `${this.serverUrl}/${logoUrl}`;
                    }
                } catch (error) {
        ...
        async submitForm() {
            try {
                const response = await axios.post('/external/appointment', this.formData);
