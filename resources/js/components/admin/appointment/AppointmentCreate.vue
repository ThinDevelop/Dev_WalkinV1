                                    ...
                                    <div class="form-group row fv-plugins-icon-container">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <select class='form-control form-control-solid form-control-lg' id="formData.department_id" v-model="formData.department_id">
                                                <option value="" disabled selected hidden>เลือกแผนก</option>
                                    ...
                                    <div class="form-group row fv-plugins-icon-container">
                                        ...
                                        <div class="col-lg-9 col-xl-9">
                                            <select v-bind:class="'form-control form-control-solid form-control-lg ' +valid.objective_id" id="formData.objective_id" v-model="formData.objective_id">
                                                <option value="" disabled selected hidden>เลือกวัตถุประสงค์</option>
...
export default{
    ...
    methods:{
        async submitForm() {
            try {
                const response = await axios.post('/admin/appointment', this.formData);
