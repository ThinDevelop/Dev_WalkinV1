                        ...
                        <div class="col-xl-9">
                            ...
                            <div class="my-5 step" >
                                ...
                                <div class="form-group row fv-plugins-icon-container">
                                    ...
                                    <div class="col-lg-9 col-xl-9">
                                        <input v-bind:class="'form-control form-control-solid form-control-lg '+valid.username" name="username" type="text" v-model="username">
                                        <span class="form-text invalid-feedback" v-if="valid.username == 'is-invalid' ">{{ error.username }}</span>
                                    </div>
                                </div>
                                <!--end::Group-->
                                <!--begin::password-->
                            ...
                            <div class="d-flex justify-content-between border-top pt-10 mt-15">
                                ...
                                <div>
                                    ...
                                    <button type="button" @click="createUser()" class="btn btn-success font-weight-bolder px-4 py-2" >บันทึก</button>
                                </div>
                            </div>
                            <!--end::Wizard Actions-->
                        </div>
...
export default{
    ...
    methods:{
        createUser(){
            ...
            Vue.axios.post('/superadmin/user',{
                _method: 'POST',
                name: this.name,
            ...
            .then((response) => {
                ...
                if(response.data.status_code == 422){
                    ...
                    this.$swal('ผิดพลาด','ไม่สามารถเพิ่มข้อมูลได้ กรุณาลองอีกครั้ง!!!');
                }
            });
        }
    }
