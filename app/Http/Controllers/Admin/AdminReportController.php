...
class AdminReportController extends Controller
{
    ...
    public function Today(Request $request){
        ...
        return view('admin.report.show',compact('type', 'date_start', 'date_from','company'));
    }
    ...
    public function CustomDate(Request $request){
        ...
        $company = Auth::user()->company_id;
        $type = '';
        return view('admin.report.show_custom',compact('type', 'date_now','company'));
    ...
    public function listDate(Request $request, $start, $from)
    {
        if (request()->ajax()) {
            ...
            // if ($type_checkin == 'checkin') {
                // $contact->where(function($where){
                    // $where->whereNull('vechicle_cost_types_id');
            ...
            //     $contact[$k]->company = $v->getCompany->name;
            // }
    ...
    public function Export(){
        ...
        return view('admin.report.export', compact('company_id', 'checkContractVechicle'));
    }
